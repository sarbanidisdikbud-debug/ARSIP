...
import { Letter, UserRole } from '../types.ts';
import { summarizeLetter } from '../services/geminiService.ts';
        ...
        <div className="lg:col-span-2 space-y-8">
            ...
            <div className="p-8">
              ...
              <div className="prose prose-slate max-w-none">
                <p className="text-slate-700 leading-relaxed whitespace-pre-wrap text-lg">
                  {letter.content || "Konten tidak tersedia."}
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-2xl p-6">
            ...
            <div className="text-amber-900/80 italic text-sm leading-relaxed">
              {letter.aiSummary || "Klik generate untuk membuat ringkasan AI."}
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm space-y-6">
            ...
            <div className="space-y-4">
              <InfoItem icon={<Calendar size={18} />} label="Tanggal" value={letter.date} />
